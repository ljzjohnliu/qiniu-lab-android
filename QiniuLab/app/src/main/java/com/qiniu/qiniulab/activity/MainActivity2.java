...
public class MainActivity2 extends AppCompatActivity {
    ...
    private String videoUploadToken = "j4uAjPplb7oCAtazVj_UQP1XH9anZSv-CJ_iy2BX:9wwpSBjKaHMOj2hFp2ygMi_CPgU=:eyJzY29wZSI6InVwbG9hZHRlc3QxMTEiLCJkZWFkbGluZSI6MTc3MjcwMzEzN30=";
    private String videoDomain = "t9v4tja4n.hn-bkt.clouddn.com";
    private String imgUploadToken = "j4uAjPplb7oCAtazVj_UQP1XH9anZSv-CJ_iy2BX:9wwpSBjKaHMOj2hFp2ygMi_CPgU=:eyJzY29wZSI6InVwbG9hZHRlc3QxMTEiLCJkZWFkbGluZSI6MTc3MjcwMzEzN30=";
    private String imgDomain = "t9v4tja4n.hn-bkt.clouddn.com";
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Log.d(TAG, "getTokenAndDomain, run: isVideo = " + isVideo + ", jsonObject = " + jsonObject);
...
//                this.simpleUploadManager = new UploadManager();
                ...
                Configuration config = new Configuration.Builder()
                        .zone(zone)
                        .buildV2();
                this.simpleUploadManager = new UploadManager(config);
            }
        } else {
